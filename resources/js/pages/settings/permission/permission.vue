    ...
    <div class="content-header row">
      ...
      >
        <div class="form-group breadcrum-right">
            <router-link :to="{ name:'settings.permission.add' }"  class="btn btn-primary mr-1 mb-1 waves-effect waves-light">Add Permission</router-link>
        </div>
      </div>
    </div>
                      ...
                      <td class="text-center">
                           <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; transform: translate3d(263px, 36px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <router-link class="dropdown-item" :to="{ name:'settings.permission.edit',params:{ id:item.id } }">Edit</router-link>
...
export default {
  ...
  methods: {
    deleteRole(id){
      axios
        .post('/api/settings/permission/destroy', { id:id })
        .then((response) => {
          this.getData()
        })
        .catch((errors) => {
    ...
    getData(url = "/api/settings/permissions") {
      this.tableData.draw++;
      axios
