                    ...
                    <form @submit.prevent="handleSubmit" @keydown="form.onKeydown($event)">
                        <alert-success :form="form" :message="message" />
                            ...
                            <div class="d-flex justify-content-between">
                                <router-link class="btn btn-secondary mr-1 mb-1 waves-effect waves-light" :to="{ name:'settings.permissions' }">Back</router-link>
...
export default {
  ...
  methods:{ 
    async handleSubmit () {
      const response = await this.form.post('/api/settings/permission/store')
